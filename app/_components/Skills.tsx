    ...
    <div className="">
      ...
      <div id="skills">
        <p className="text-base text-white mb-24 w-[700px] dark:text-black max-md:w-[370px]">
          💪 Fort d&aposune <strong className="text-red-500">expérience de six ans</strong> dans la logistique d’un commerce de gros avec une expérience en vente/bureau d&apos;étude en électricité, j&apos;ai pu acquérir 
